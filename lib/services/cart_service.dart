...
class CartService {
  ...
  static Future updateCart(int cartId, int productId, int quantity) async{
    ...
    var response = await Apiutil.dio.patch('/cart/$cartId',data: {"product_id": productId, "qty": quantity}, );
    return response;
  }
}
